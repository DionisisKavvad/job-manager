    ...
    tasks: [
      {
        ...
        output: { products: 42, images: 128, pages: 15 },
        summary: "Scraped 42 products, 128 images, and 15 pages from the target store.",
        durationMs: 45200,
        usage: { inputTokens: 12500, outputTokens: 3200, cacheReadInputTokens: 8000 },
        feedbackResult: null,
      },
      {
        taskId: "color-tags",
        ...
        lastEventType: "Task Submitted For Review",
        lastEventAt: Date.now() - 1200_000,
        output: { primaryColor: "#1E40AF", secondaryColor: "#F59E0B", palette: ["#1E40AF", "#F59E0B", "#10B981", "#6B7280"] },
        summary: "Extracted 4-color brand palette: primary blue, secondary amber, accent green, neutral gray.",
        durationMs: 32100,
        usage: { inputTokens: 18200, outputTokens: 4100, cacheReadInputTokens: 12000 },
        feedbackResult: null,
      },
      {
        taskId: "font-pairing",
        ...
        requiresReview: true,
        repo: "org/frontend-app",
        lastEventType: "Task Processing Started",
        lastEventAt: Date.now() - 600_000,
        output: null,
        summary: null,
        durationMs: null,
        usage: null,
        feedbackResult: { passed: false, rounds: 1, reason: "Font pairing lacked contrast" },
      },
      {
    ...
    tasks: [
      {
        ...
        output: { competitors: 5, insights: 12 },
        summary: "Analyzed 5 competitors across pricing, features, and market positioning.",
        durationMs: 62400,
        usage: { inputTokens: 22000, outputTokens: 8500 },
        feedbackResult: null,
      },
      {
        ...
        output: { reportUrl: "/reports/competitor-analysis.pdf", sections: 4 },
        summary: "Compiled 4-section comparison report with pricing matrix and feature grid.",
        durationMs: 28900,
        usage: { inputTokens: 15000, outputTokens: 6200 },
        feedbackResult: null,
      },
    ],
  },
    ...
    tasks: [
      {
        ...
        output: { pages: 8, assets: 34 },
        summary: "Scraped 8 pages and 34 design assets from the store.",
        durationMs: 38500,
        usage: { inputTokens: 9800, outputTokens: 2100 },
        feedbackResult: null,
      },
      {
